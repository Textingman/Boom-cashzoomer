        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-8">
            <input
              ...
              className="w-full bg-gray-50 rounded-lg p-6 text-3xl font-bold text-gray-900 tracking-wider text-center border-2 border-gray-200 focus:border-[#10B981] focus:outline-none transition-colors"
            />
          </div>
