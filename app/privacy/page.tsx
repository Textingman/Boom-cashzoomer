          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/privacy" className="text-gray-900 hover:text-[#10B981] px-3 py-2 rounded-md text-sm font-medium">
                  Privacy
                </Link>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            Cash Zoomer ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our SMS verification service and website.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            To exercise these rights, please contact us at <a href="mailto:privacy@cashzoomer.com" className="text-[#10B981] hover:text-[#059669]">privacy@cashzoomer.com</a>.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-600 mb-2"><strong>Email:</strong> <a href="mailto:privacy@cashzoomer.com" className="text-[#10B981] hover:text-[#059669]">privacy@cashzoomer.com</a></p>
