          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/about" className="text-gray-900 hover:text-[#10B981] px-3 py-2 rounded-md text-sm font-medium">
                  About
                </Link>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-4">
              Cash Zoomer was created to solve a critical problem: businesses need a reliable way to verify customer identity via SMS while maintaining high delivery rates.
            </p>
            <p className="text-lg text-gray-600 mb-4">
      ...
      <section className="bg-[#10B981] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join businesses that trust Cash Zoomer for SMS verification.
          </p>
          <Link
            href="/signup"
